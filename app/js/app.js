...
app.controller('BlogController', function($scope) {
	$scope.items = [
		...
		{id: 6,title: 'Project:EndGoal',order:0, content:'<p>An angularjs app that can track an goals you may have.</p>', type: 'item active blog', unselected: true},
		...
		{id: 10,title: 'Blog 7',order:0, content:5, type: 'item active', unselected: true},
		{id: 11,title: 'Blog 8',order:0, content:5, type: 'item active', unselected: true}
	];
